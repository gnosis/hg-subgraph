...
import { Question, Category, ScalarQuestionLink, Condition } from '../generated/schema'
import { assignQuestionToCondition } from './conditions'
...
export function handleNewQuestion(event: LogNewQuestion): void {
  ...
  question.arbitrator = event.params.arbitrator.toHexString();
